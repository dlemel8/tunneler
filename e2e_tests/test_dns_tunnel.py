...
@pytest.mark.asyncio
async def test_single_client_single_echo(echo_backend_server, server_container, client_container) -> None:
    message_to_send = 'bla'
...
@pytest.mark.asyncio
async def test_single_client_multiple_echo(echo_backend_server, server_container, client_container) -> None:
